// ─────────────────────────────────────────────────────────────────────
// FILE PATH: app/components/premium/WeddingSchedule.tsx
// ─────────────────────────────────────────────────────────────────────
"use client";
...
const SCHEDULE = [
  {
    ...
    icon: "/illustrations/premium/icon-ceremony.svg",
    iconAlt: "Rings icon",
    w: 88, h: 84,
    emoji: "💍",
  },
  {
    ...
    icon: "/illustrations/premium/icon-photos.svg",
    iconAlt: "Camera icon",
    w: 82, h: 85,
    emoji: "📸",
  },
  {
    ...
    icon: "/illustrations/premium/icon-reception.svg",
    iconAlt: "Reception icon",
    w: 98, h: 89,
    emoji: "🥂",
  },
  {
    ...
    icon: "/illustrations/premium/icon-celebration.svg",
    iconAlt: "Music icon",
    w: 88, h: 86,
    emoji: "🎉",
  },
...
const CONFETTI_COLORS = [
  "#f7f3ee", "#c9a97e", "#eaba99", "#e1c6ab", "#ffffff",
  "#bb8e73", "#a8795b", "#ffe4c4", "#ffd700",
];
...
export function WeddingSchedule() {
  ...
  return (
    <>
      ...
      <section
        id="details"
        className="relative overflow-hidden bg-[#a8795b] px-6 py-[100px]"
      >
        {/* ── Decorative background circles ── */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
          {/* Large circles — softly pulsing */}
          ...
          {/* Filled soft glow spots */}
          <div className="absolute left-1/4 top-1/2 -translate-y-1/2 h-64 w-64 rounded-full opacity-[0.06]"
            style={{ background: "radial-gradient(circle,#f7f3ee,transparent 70%)" }} />
          <div className="absolute right-1/4 top-1/2 -translate-y-1/2 h-64 w-64 rounded-full opacity-[0.06]"
            style={{ background: "radial-gradient(circle,#f7f3ee,transparent 70%)" }} />
        </div>
        ...
        <div className="relative mx-auto max-w-[1280px]">
          <div className="flex flex-col items-center gap-16">
            ...
            <div className="flex flex-col items-center gap-5 text-center">
              <p className="text-[13px] font-semibold uppercase tracking-[1.3px] text-[#eaba99]">
                Ratiba ya Harusi
              </p>
              <h2
                className="max-w-[478px] text-[clamp(36px,5vw,64px)] leading-[1.0] text-white"
            ...
            <div className="grid w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {SCHEDULE.map((item, i) => {
                ...
                return (
                  ...
                  >
                    {/* Card background — slides up on hover */}
                    <div
                      className="absolute inset-0 rounded-none transition-all duration-400"
                      style={{
                    ...
                    <div className="relative flex flex-col items-center gap-6 p-6 w-full">
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        {/* Emoji surprise on hover */}
                        <div
                          style={{
                            opacity: isHovered ? 1 : 0,
                            transform: isHovered ? "translateY(0) scale(1)" : "translateY(8px) scale(0.5)",
                        ...
                        <p
                          className="text-[clamp(32px,4vw,48px)] leading-none text-[#eee6db]"
                      ...
                      <div
                        ...
                        style={{ width: isHovered ? "60px" : "48px" }}
                      />

                      {/* Title + description */}
                      <div className="flex flex-col items-center gap-3">
                        <h3
                          className="text-[clamp(18px,2vw,24px)] italic leading-[1.3] text-[#eee1d4] transition-colors duration-300"
                          style={{
                            fontFamily: "'Cormorant Garamond',serif",
                            color: isHovered ? "#f7f3ee" : "#eee1d4",
                          }}
                        >
                          {item.title}
                        </h3>
                        <p
                          className="max-w-[266px] text-[14px] leading-[1.7] text-[#eaba99] transition-colors duration-300"
                      ...
                      {/* "Click to celebrate" hint — shows on hover */}
                      <p
                        className="text-[9px] uppercase tracking-[0.2em] text-white/40 transition-all duration-300"
